...
var createStartupClientIndexCoffee = require('../template/application-imports-startup-client-index.js')
var createStartupServerIndexCoffee = require('../template/application-imports-startup-server-index.js')
...
var createApplication = function (appName) {
  ...
  fs.outputFileSync('imports/startup/client/index.coffee', createStartupClientIndexCoffee());
  fs.outputFileSync('imports/startup/server/index.coffee', createStartupServerIndexCoffee());
  return true
}
